...
namespace GreyWind.SolidPlayGround
{
    ...
    public class DocumentEventHandler
    {
        ...
        protected SolidWorksAddin userAddin;

        protected Hashtable openModelViews;

        public DocumentEventHandler(ModelDoc2 modDoc, SolidWorksAddin addin)
        {
            document = modDoc;
            userAddin = addin;
    ...
    public class PartEventHandler : DocumentEventHandler
    {
        ...
        public PartEventHandler(ModelDoc2 modDoc, SolidWorksAddin addin)
            : base(modDoc, addin)
        {
    ...
    {
        AssemblyDoc doc;
        SolidWorksAddin swAddin;

        public AssemblyEventHandler(ModelDoc2 modDoc, SolidWorksAddin addin)
            : base(modDoc, addin)
        {
    ...
    public class DrawingEventHandler : DocumentEventHandler
    {
        ...
        public DrawingEventHandler(ModelDoc2 modDoc, SolidWorksAddin addin)
            : base(modDoc, addin)
        {
    ...
    {
        ISldWorks iSwApp;
        SolidWorksAddin userAddin;
        ModelView mView;
        DocumentEventHandler parent;

        public DocView(SolidWorksAddin addin, IModelView mv, DocumentEventHandler doc)
        {
            userAddin = addin;
            mView = (ModelView)mv;
            iSwApp = (ISldWorks)userAddin.SwApp;
